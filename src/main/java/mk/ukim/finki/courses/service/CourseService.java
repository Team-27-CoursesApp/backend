...
public interface CourseService {
    ...
    Optional<Course> saveCourse(String name, String description, Double price, Long lecturer, List<Long> students, CourseCategory category);

    Optional<Course> updateCourse(Long id, String name, String description, Double price, Long lecturer,CourseCategory category);
